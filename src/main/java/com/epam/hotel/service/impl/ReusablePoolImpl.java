...
import com.epam.hotel.service.ReusablePool;
...
public class ReusablePoolImpl implements ReusablePool {
    private final Logger logger = Logger.getLogger(ReusablePoolImpl.class);
