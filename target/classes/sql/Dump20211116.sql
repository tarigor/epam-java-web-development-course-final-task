...
(
    ...
    CONSTRAINT `client_order_id_fk` FOREIGN KEY (`client_order_id`) REFERENCES `client_order` (`id`) ON UPDATE RESTRICT,
...
/*!40000 ALTER TABLE `client_order_room`
    DISABLE KEYS */;
INSERT INTO `client_order_room`
VALUES (1, 1, 1, '2021-11-25', 4, 'approved and booked'),
       (2, 2, 2, '2021-11-30', 3, 'waiting for approval'),
       (2, 3, 2, '2021-12-08', 7, 'approved and booked'),
       (3, 6, 2, '2021-12-31', 2, 'waiting for approval');
/*!40000 ALTER TABLE `client_order_room`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES (1, 'Igor', 'Taren', 'admin', NULL, NULL),
       (2, 'Ivan', 'Pupkin', 'client', NULL, NULL),
       (3, 'Stepan', 'Vilkin', 'client', NULL, NULL),
       (4, 'Svetlana', 'Otverkina', 'client', NULL, NULL);
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-16 20:55:52
